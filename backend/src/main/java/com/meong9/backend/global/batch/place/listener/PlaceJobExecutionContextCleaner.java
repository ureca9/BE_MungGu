...
@Component("placeJobExecutionContextCleaner")
@Slf4j
public class PlaceJobExecutionContextCleaner implements JobExecutionListener {
    ...
    private static final String[] KEYS_TO_REMOVE = {"topPlaceIds", "topFeatureIds"};
